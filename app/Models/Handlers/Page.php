...
//在分页信息中显示内容，可以自己通过set()方法设置
    ...
    public function __construct($total, $listRows=25, $query="", $ord=true){
        ...
        /*以下判断用来设置当前面*/
        $get_page = $this->getContext()->getInput()->get('page');
        if(!empty($get_page)) {
            $page = $get_page;
        }else{
            if($ord)
    ...
    function fpage(){
        ...
        $html[0] = "<span class='layui-laypage-curr'>&nbsp;<em class=\"layui-laypage-em\"></em><em>共<b> {$this->total} </b>{$this->config["head"]}</em>&nbsp;</span>";
        $html[1] = "&nbsp;<span class='layui-laypage-curr'><em class=\"layui-laypage-em\"></em><em>本页 <b>".$this->disnum()."</b> 条</em></span>&nbsp;";
        $html[2] = "&nbsp;<span class='layui-laypage-curr'><em class=\"layui-laypage-em\"></em><em>本页从 <b>{$this->start()}-{$this->end()}</b> 条</em></span>&nbsp;";
    ...
    private function pageList(){
        ...
        /*当前页的信息 */
        if($this->pageNum > 1)
            $linkPage .= "<span class='layui-laypage-curr'>{$this->page}</span>&nbsp;";
    ...
    private function goPage(){
        if($this->pageNum > 1) {
            return '&nbsp;<input style="border:1px solid #CCCCCC;" type="text" onkeydown="javascript:if(event.keyCode==13){var page=(this.value>'.$this->pageNum.')?'.$this->pageNum.':this.value;location=\''.$this->uri.'page=\'+page+\'\'}" value="'.$this->page.'"><input style="cursor:pointer;border:1px solid #CCCCCC;" type="button" value="GO" onclick="javascript:var page=(this.previousSibling.value>'.$this->pageNum.')?'.$this->pageNum.':this.previousSibling.value;location=\''.$this->uri.'page=\'+page+\'\'">&nbsp;';
        }
    }
